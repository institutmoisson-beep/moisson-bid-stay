...
Multi-currency wallet with auto-conversion via Frankfurter API (edge function exchange-rates).

## Memories
- [Design tokens](mem://design/tokens) — Black & gold premium palette, gradients, glass effects
- [Database schema](mem://features/schema) — profiles, residences, residence_images, user_roles, needs, notifications, orders, wallet_transactions, payment_methods, platform_settings, referral_commissions, ratings, city_manager_zones, exchange_rates
...
- [Currencies](mem://features/currencies) — Multi-currency support with XAF default, Frankfurter API for rates, auto-conversion on transfers
